...
namespace SnaaaaaaaaaaaaaKKKKKEEEE
{
    public class Snake
    {
        ...
        public Queue<Pixel> Body { get; } = new Queue<Pixel>(); //зочем напрягаться когда можно просто сделать очередь XD

        public void Move(Direction direction, bool eat = false) //движение или же управление
        {
            Clear();
