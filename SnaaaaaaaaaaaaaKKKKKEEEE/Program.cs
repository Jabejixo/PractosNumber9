...
using static System.Console;//удобная вещь чтобы не заморачиваться
namespace SnaaaaaaaaaaaaaKKKKKEEEE
{
    internal class Program
    {
        ...
        static void Main()
        {
            SetWindowSize(MapWidth * 3, MapHeight * 3); //хотел просто изначально сделать эти перемнные а 3 раза больше но чот не вышло, а если так написать то все работает
            SetBufferSize(MapWidth * 3, MapHeight * 3);
            CursorVisible = false;
        ...
        static void StartGame()
        {
            ...
            while (true)
            {
                ...
                /*условия чтобы когда змейка врежется в себя игра была окончена*/
        ...
        static void DrawBoard() //Бортики, это база
        {
        ...
        static Pixel GenFood(Snake snake) //генерация еды, змейку принимает чтобы через условия еда не генерилась на самой змейке
        {
            Pixel food;
        ...
        static Direction ReadMovement(Direction currentDirection)
        {
            ...
            currentDirection = key switch //А боже это гениально, теперь тока так и буду писать
            {
